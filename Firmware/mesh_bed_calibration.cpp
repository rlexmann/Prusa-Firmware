...
//    SERIAL_ECHOPGM("");
	...
	while (iteration < 3) {
		...
		for (int k = 0; k < 4; ++k) {
			...
			/*
			RLE: My heatbed has a problematic top center mesh point (basterd).
			To make calibration possible, I measure XY position of top left and right
			corners instead and set their average for the basterd.
			*/
